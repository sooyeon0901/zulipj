...
public class MessageApi {
  ...
  private static Admin ta = new Admin();
  
  //메시지 보내기
  public void sendStreamMessage() throws MalformedURLException, ZulipClientException {
  ...
  //메시지 가져오기 (1)
  public static void getMsg1() throws MalformedURLException, ZulipClientException {
      ZulipAdminUtils adminUtils = ta.setAdmin();
  ...
  //메시지 가져오기 (2)
  public static void getMsg2() throws MalformedURLException, ZulipClientException {
      ZulipAdminUtils adminUtils = ta.setAdmin();
      ZulipHttpClient userClient = adminUtils.createClient(ta.ADMIN_EMAIL, ta.USER_PW);
  ...
  //메시지 가져오기 (3)
  public static void getMsg3() throws MalformedURLException, ZulipClientException {
      ZulipAdminUtils adminUtils = ta.setAdmin();
      ZulipHttpClient userClient = adminUtils.createClient(ta.ADMIN_EMAIL, ta.USER_PW);
  ...
  // 개인 메시지 보내기 dm
  public static void sendPrivMsg() throws MalformedURLException, ZulipClientException {
      ZulipAdminUtils adminUtils = ta.setAdmin();
  ...
  // 이모지 생성/삭제
  public static void emoji() throws MalformedURLException, ZulipClientException {
      ZulipAdminUtils adminUtils = ta.setAdmin();
      Zulip z_admin = adminUtils.createZulip(ta.ADMIN_EMAIL, ta.USER_PW);
      /* [이모지 추가]
  ...
  */
  public static void uploadFile() throws MalformedURLException, ZulipClientException {
   ...
   *  boolean b = z_admin.messages().matchMessages().equals("ddd");
      log.info("b=={}", b);
  */
  public static void match() throws MalformedURLException, ZulipClientException {
      ZulipAdminUtils adminUtils = ta.setAdmin();
      Zulip z_admin = adminUtils.createZulip(ta.ADMIN_EMAIL, ta.USER_PW);
   ...
   * return void
  */
  public static void editMsg() throws MalformedURLException, ZulipClientException {
      ZulipAdminUtils adminUtils = ta.setAdmin();
      Zulip z_admin = adminUtils.createZulip(ta.ADMIN_EMAIL, ta.USER_PW);
      // 메시지 수정
  ...
  */
  public static void flagMsg() throws MalformedURLException, ZulipClientException {
      ZulipAdminUtils adminUtils = ta.setAdmin();
      Zulip z_admin = adminUtils.createZulip(ta.ADMIN_EMAIL, ta.USER_PW);
      com.github.jamesnetherton.zulip.client.api.message.Message m = z_admin.messages().getMessage(251).execute();
